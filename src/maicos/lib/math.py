...
def atomic_form_factor(q: float, element: str) -> float:
    ...
    """
    if element == "CH1":
        form_factor = atomic_form_factor(q, "C") + atomic_form_factor(q, "H")
    elif element == "CH2":
        form_factor = atomic_form_factor(q, "C") + 2 * atomic_form_factor(q, "H")
    elif element == "CH3":
        form_factor = atomic_form_factor(q, "C") + 3 * atomic_form_factor(q, "H")
    elif element == "CH4":
        form_factor = atomic_form_factor(q, "C") + 4 * atomic_form_factor(q, "H")
    elif element == "NH1":
        form_factor = atomic_form_factor(q, "N") + atomic_form_factor(q, "H")
    elif element == "NH2":
        form_factor = atomic_form_factor(q, "N") + 2 * atomic_form_factor(q, "H")
    elif element == "NH3":
        form_factor = atomic_form_factor(q, "N") + 3 * atomic_form_factor(q, "H")
    else:
