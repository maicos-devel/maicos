...
from ..lib.weights import charge_theta_weights


@render_docs
class ChargeXCylinder(ProfileCylinderBase):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            bin_method=bin_method,
            output=output,
            weighting_function=charge_theta_weights,
            weighting_function_kwargs={"get_unit_vectors": get_unit_vectors,
            normalization="volume",
        )

    def _prepare(self):
        logging.info(f"Analysis of charge cos theta profile.")
        super()._prepare()
