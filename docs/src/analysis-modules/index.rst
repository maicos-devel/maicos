...
example section for each module. Instead, we refer to our :ref:`userdoc-basic-usage` and
:ref:`userdoc-how-to`. Once you understand the basic structure taught there, you can
