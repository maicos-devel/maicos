...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/Users/philip/Library/Python/2.7/lib/python/site-packages/numpy/core/include/numpy/arrayobject.h", 
            "/Users/philip/Library/Python/2.7/lib/python/site-packages/numpy/core/include/numpy/ufuncobject.h"
        ], 
        "extra_compile_args": [
            "-fopenmp"
        ], 
        ...
        "include_dirs": [
            "/Users/philip/Library/Python/2.7/lib/python/site-packages/numpy/core/include"
        ], 
        "name": "sfactor", 
        "sources": [
            "mdtools/ana/sfactor/sfactor.pyx"
        ]
    }, 
    "module_name": "sfactor"
}
...
#define __PYX_HAVE__mdtools__ana__sfactor__sfactor
#define __PYX_HAVE_API__mdtools__ana__sfactor__sfactor
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'mdtools.ana.sfactor.sfactor' */
...
static PyObject *__pyx_f_7mdtools_3ana_7sfactor_7sfactor_compute_structure_factor(__Pyx_memviewslice, __Pyx_memviewslice, double, double, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "mdtools.ana.sfactor.sfactor"
extern int __pyx_module_is_main_mdtools__ana__sfactor__sfactor;
int __pyx_module_is_main_mdtools__ana__sfactor__sfactor = 0;

/* Implementation of 'mdtools.ana.sfactor.sfactor' */
...
static PyObject *__pyx_pf_7mdtools_3ana_7sfactor_7sfactor_compute_structure_factor(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_positions, __Pyx_memviewslice __pyx_v_boxdimensions, double __pyx_v_start_q, double __pyx_v_end_q); /* proto */
...
/* "mdtools/ana/sfactor/sfactor.pyx":11
...
static PyObject *__pyx_pw_7mdtools_3ana_7sfactor_7sfactor_1compute_structure_factor(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_7mdtools_3ana_7sfactor_7sfactor_compute_structure_factor(__Pyx_memviewslice __pyx_v_positions, __Pyx_memviewslice __pyx_v_boxdimensions, double __pyx_v_start_q, double __pyx_v_end_q, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "mdtools/ana/sfactor/sfactor.pyx":14
 *     """Calculates S(|q|) for all possible q values. Returns the q values as well as the scattering factor."""
 * 
 ...
 */
  ...
  /* "mdtools/ana/sfactor/sfactor.pyx":15
 * 
 *     assert(boxdimensions.shape[0]==3);
 *     assert(positions.shape[1]==3);             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "mdtools/ana/sfactor/sfactor.pyx":18
 * 
 *     cdef Py_ssize_t i, j, k, l, n_atoms;
 ...
 */
  ...
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_int32); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, __pyx_t_4) < 0) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_tuple_, __pyx_t_1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_4);
  if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_maxn = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "mdtools/ana/sfactor/sfactor.pyx":20
 *     cdef int[:] maxn = np.empty(3,dtype=np.int32);
 *     cdef double qx, qy, qz, qrr, qdotr, sin, cos;
 *     cdef double[:] q_factor = np.empty(3,dtype=np.double);             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_empty); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_tuple__2, __pyx_t_4); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  /* "mdtools/ana/sfactor/sfactor.pyx":22
 *     cdef double[:] q_factor = np.empty(3,dtype=np.double);
 * 
 *     n_atoms = positions.shape[0];             # <<<<<<<<<<<<<<
 *     for i in range(3):
 ...
 */
  ...
  /* "mdtools/ana/sfactor/sfactor.pyx":23
 * 
 *     n_atoms = positions.shape[0];
 *     for i in range(3):             # <<<<<<<<<<<<<<
 *         q_factor[i] = 2*np.pi/boxdimensions[i];
 ...
 */
  for (__pyx_t_7 = 0; __pyx_t_7 < 3; __pyx_t_7+=1) {
    ...
    /* "mdtools/ana/sfactor/sfactor.pyx":24
 *     n_atoms = positions.shape[0];
 *     for i in range(3):
 *         q_factor[i] = 2*np.pi/boxdimensions[i];             # <<<<<<<<<<<<<<
 *         maxn[i] = <int>math.ceil(end_q/<float>q_factor[i]);
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyNumber_Multiply(__pyx_int_2, __pyx_t_4); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 24, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_8 = __pyx_v_i;
    __pyx_t_4 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_boxdimensions.data + __pyx_t_8 * __pyx_v_boxdimensions.strides[0]) )))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 24, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_1 = __Pyx_PyNumber_Divide(__pyx_t_3, __pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 24, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_q_factor.data + __pyx_t_10 * __pyx_v_q_factor.strides[0]) )) = __pyx_t_9;

    /* "mdtools/ana/sfactor/sfactor.pyx":25
 *     for i in range(3):
 *         q_factor[i] = 2*np.pi/boxdimensions[i];
 *         maxn[i] = <int>math.ceil(end_q/<float>q_factor[i]);             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_12 = ((float)(*((double *) ( /* dim=0 */ (__pyx_v_q_factor.data + __pyx_t_11 * __pyx_v_q_factor.strides[0]) ))));
    if (unlikely(__pyx_t_12 == 0)) {
      PyErr_SetString(PyExc_ZeroDivisionError, "float division");
      __PYX_ERR(0, 25, __pyx_L1_error)
    }
    __pyx_t_13 = __pyx_v_i;
    *((int *) ( /* dim=0 */ (__pyx_v_maxn.data + __pyx_t_13 * __pyx_v_maxn.strides[0]) )) = ((int)ceil((__pyx_v_end_q / __pyx_t_12)));
  }

  /* "mdtools/ana/sfactor/sfactor.pyx":27
 *         maxn[i] = <int>math.ceil(end_q/<float>q_factor[i]);
 * 
 *     cdef double[:,:,:] S_array = np.zeros(maxn, dtype=np.double);             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_maxn, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_14 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_double); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_14);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, __pyx_t_14) < 0) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
  __pyx_t_14 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_14);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_15 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(__pyx_t_14);
  if (unlikely(!__pyx_t_15.memview)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
  __pyx_v_S_array = __pyx_t_15;
  __pyx_t_15.memview = NULL;
  __pyx_t_15.data = NULL;

  /* "mdtools/ana/sfactor/sfactor.pyx":28
 * 
 *     cdef double[:,:,:] S_array = np.zeros(maxn, dtype=np.double);
 *     cdef double[:,:,:] q_array = np.zeros(maxn, dtype=np.double);             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_14);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_14, __pyx_n_s_zeros); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
  __pyx_t_14 = __pyx_memoryview_fromslice(__pyx_v_maxn, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_14);
  ...
  __pyx_t_14 = 0;
  __pyx_t_14 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_14);
  __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_double); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_14, __pyx_n_s_dtype, __pyx_t_2) < 0) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_3, __pyx_t_14); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
  __pyx_t_15 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(__pyx_t_2);
  if (unlikely(!__pyx_t_15.memview)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_q_array = __pyx_t_15;
  __pyx_t_15.memview = NULL;
  __pyx_t_15.data = NULL;

  /* "mdtools/ana/sfactor/sfactor.pyx":30
 *     cdef double[:,:,:] q_array = np.zeros(maxn, dtype=np.double);
 * 
 *     for i in prange(<int>maxn[0],nogil=True):             # <<<<<<<<<<<<<<
 *         qx = i * q_factor[0];
 ...
 */
  {
      ...
      #endif
      /*try:*/ {
        if (unlikely(!__pyx_v_maxn.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("maxn"); __PYX_ERR(0, 30, __pyx_L6_error) }
        __pyx_t_16 = 0;
        __pyx_t_17 = ((int)(*((int *) ( /* dim=0 */ (__pyx_v_maxn.data + __pyx_t_16 * __pyx_v_maxn.strides[0]) ))));
        if (1 == 0) abort();
        {
                ...
                #define unlikely(x) (x)
            #endif
            __pyx_t_18 = (__pyx_t_17 - 0 + 1 - 1/abs(1)) / 1;
            if (__pyx_t_18 > 0)
            {
                #ifdef _OPENMP
                #pragma omp parallel reduction(+:__pyx_v_cos) reduction(+:__pyx_v_sin) private(__pyx_t_19, __pyx_t_20, __pyx_t_21, __pyx_t_22, __pyx_t_23, __pyx_t_24, __pyx_t_25, __pyx_t_26, __pyx_t_27, __pyx_t_28, __pyx_t_29, __pyx_t_30, __pyx_t_31, __pyx_t_32, __pyx_t_33, __pyx_t_34, __pyx_t_35, __pyx_t_36, __pyx_t_37, __pyx_t_38, __pyx_t_39, __pyx_t_40, __pyx_t_41, __pyx_t_42, __pyx_t_43)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_j) lastprivate(__pyx_v_k) lastprivate(__pyx_v_l) lastprivate(__pyx_v_qdotr) lastprivate(__pyx_v_qrr) lastprivate(__pyx_v_qx) lastprivate(__pyx_v_qy) lastprivate(__pyx_v_qz)
                    #endif /* _OPENMP */
                    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_18; __pyx_t_7++){
                        {
                            ...
                            /* "mdtools/ana/sfactor/sfactor.pyx":31
 * 
 *     for i in prange(<int>maxn[0],nogil=True):
 *         qx = i * q_factor[0];             # <<<<<<<<<<<<<<
 * 
 ...
 */
                            __pyx_t_19 = 0;
                            __pyx_v_qx = (__pyx_v_i * (*((double *) ( /* dim=0 */ (__pyx_v_q_factor.data + __pyx_t_19 * __pyx_v_q_factor.strides[0]) ))));

                            /* "mdtools/ana/sfactor/sfactor.pyx":33
 *         qx = i * q_factor[0];
 * 
 *         for j in range(maxn[1]):             # <<<<<<<<<<<<<<
 *             qy = j * q_factor[1];
 ...
 */
                            __pyx_t_20 = 1;
                            __pyx_t_21 = (*((int *) ( /* dim=0 */ (__pyx_v_maxn.data + __pyx_t_20 * __pyx_v_maxn.strides[0]) )));
                            for (__pyx_t_22 = 0; __pyx_t_22 < __pyx_t_21; __pyx_t_22+=1) {
                              __pyx_v_j = __pyx_t_22;

                              /* "mdtools/ana/sfactor/sfactor.pyx":34
 * 
 *         for j in range(maxn[1]):
 *             qy = j * q_factor[1];             # <<<<<<<<<<<<<<
 * 
 ...
 */
                              __pyx_t_23 = 1;
                              __pyx_v_qy = (__pyx_v_j * (*((double *) ( /* dim=0 */ (__pyx_v_q_factor.data + __pyx_t_23 * __pyx_v_q_factor.strides[0]) ))));

                              /* "mdtools/ana/sfactor/sfactor.pyx":36
 *             qy = j * q_factor[1];
 * 
 *             for k in range(maxn[2]):             # <<<<<<<<<<<<<<
 *                 if (i + j + k != 0):
 ...
 */
                              __pyx_t_24 = 2;
                              __pyx_t_25 = (*((int *) ( /* dim=0 */ (__pyx_v_maxn.data + __pyx_t_24 * __pyx_v_maxn.strides[0]) )));
                              for (__pyx_t_26 = 0; __pyx_t_26 < __pyx_t_25; __pyx_t_26+=1) {
                                __pyx_v_k = __pyx_t_26;

                                /* "mdtools/ana/sfactor/sfactor.pyx":37
 * 
 *             for k in range(maxn[2]):
 *                 if (i + j + k != 0):             # <<<<<<<<<<<<<<
 *                     qz = k * q_factor[2];
 ...
 */
                                __pyx_t_27 = ((((__pyx_v_i + __pyx_v_j) + __pyx_v_k) != 0) != 0);
                                if (__pyx_t_27) {

                                  /* "mdtools/ana/sfactor/sfactor.pyx":38
 *             for k in range(maxn[2]):
 *                 if (i + j + k != 0):
 *                     qz = k * q_factor[2];             # <<<<<<<<<<<<<<
 *                     qrr = math.sqrt(qx*qx+qy*qy+qz*qz);
 ...
 */
                                  __pyx_t_28 = 2;
                                  __pyx_v_qz = (__pyx_v_k * (*((double *) ( /* dim=0 */ (__pyx_v_q_factor.data + __pyx_t_28 * __pyx_v_q_factor.strides[0]) ))));

                                  /* "mdtools/ana/sfactor/sfactor.pyx":39
 *                 if (i + j + k != 0):
 *                     qz = k * q_factor[2];
 *                     qrr = math.sqrt(qx*qx+qy*qy+qz*qz);             # <<<<<<<<<<<<<<
 * 
 ...
 */
                                  ...
                                  /* "mdtools/ana/sfactor/sfactor.pyx":41
 *                     qrr = math.sqrt(qx*qx+qy*qy+qz*qz);
 * 
 *                     if (qrr >= start_q and qrr <= end_q):             # <<<<<<<<<<<<<<
 *                         q_array[i,j,k] = qrr;
 * 
 */
                                  __pyx_t_29 = ((__pyx_v_qrr >= __pyx_v_start_q) != 0);
                                  if (__pyx_t_29) {
                                  } else {
                                    __pyx_t_27 = __pyx_t_29;
                                    goto __pyx_L18_bool_binop_done;
                                  }
                                  __pyx_t_29 = ((__pyx_v_qrr <= __pyx_v_end_q) != 0);
                                  __pyx_t_27 = __pyx_t_29;
                                  __pyx_L18_bool_binop_done:;
                                  if (__pyx_t_27) {

                                    /* "mdtools/ana/sfactor/sfactor.pyx":42
 * 
 *                     if (qrr >= start_q and qrr <= end_q):
 *                         q_array[i,j,k] = qrr;             # <<<<<<<<<<<<<<
 * 
 ...
 */
                                    ...
                                    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_q_array.data + __pyx_t_30 * __pyx_v_q_array.strides[0]) ) + __pyx_t_31 * __pyx_v_q_array.strides[1]) ) + __pyx_t_32 * __pyx_v_q_array.strides[2]) )) = __pyx_v_qrr;

                                    /* "mdtools/ana/sfactor/sfactor.pyx":44
 *                         q_array[i,j,k] = qrr;
 * 
 *                         sin = 0;             # <<<<<<<<<<<<<<
 *                         cos = 0;
 ...
 */
                                    ...
                                    /* "mdtools/ana/sfactor/sfactor.pyx":45
 * 
 *                         sin = 0;
 *                         cos = 0;             # <<<<<<<<<<<<<<
 *                         for l in range(n_atoms):
 ...
 */
                                    ...
                                    /* "mdtools/ana/sfactor/sfactor.pyx":46
 *                         sin = 0;
 *                         cos = 0;
 *                         for l in range(n_atoms):             # <<<<<<<<<<<<<<
 *                             qdotr = positions[l,0]*qx + positions[l,1]*qy + positions[l,2]*qz;
 ...
 */
                                      ...
                                      __pyx_t_40 = 2;
                                      __pyx_v_qdotr = ((((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_positions.data + __pyx_t_35 * __pyx_v_positions.strides[0]) ) + __pyx_t_36 * __pyx_v_positions.strides[1]) ))) * __pyx_v_qx) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_positions.data + __pyx_t_37 * __pyx_v_positions.strides[0]) ) + __pyx_t_38 * __pyx_v_positions.strides[1]) ))) * __pyx_v_qy)) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_positions.data + __pyx_t_39 * __pyx_v_positions.strides[0]) ) + __pyx_t_40 * __pyx_v_positions.strides[1]) ))) * __pyx_v_qz));

                                      /* "mdtools/ana/sfactor/sfactor.pyx":48
 *                         for l in range(n_atoms):
 *                             qdotr = positions[l,0]*qx + positions[l,1]*qy + positions[l,2]*qz;
 *                             sin += math.sin(qdotr);             # <<<<<<<<<<<<<<
 *                             cos += math.cos(qdotr);
 ...
 */
                                      ...
                                      /* "mdtools/ana/sfactor/sfactor.pyx":49
 *                             qdotr = positions[l,0]*qx + positions[l,1]*qy + positions[l,2]*qz;
 *                             sin += math.sin(qdotr);
 *                             cos += math.cos(qdotr);             # <<<<<<<<<<<<<<
 * 
 ...
 */
                                    ...
                                    /* "mdtools/ana/sfactor/sfactor.pyx":51
 *                             cos += math.cos(qdotr);
 * 
 *                         S_array[i,j,k] += sin*sin + cos*cos;             # <<<<<<<<<<<<<<
 * 
 ...
 */
                                    ...
                                    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_S_array.data + __pyx_t_41 * __pyx_v_S_array.strides[0]) ) + __pyx_t_42 * __pyx_v_S_array.strides[1]) ) + __pyx_t_43 * __pyx_v_S_array.strides[2]) )) += ((__pyx_v_sin * __pyx_v_sin) + (__pyx_v_cos * __pyx_v_cos));
 ...
 */
  ...
  /* "mdtools/ana/sfactor/sfactor.pyx":53
 *                         S_array[i,j,k] += sin*sin + cos*cos;
 * 
 *     return (q_array,S_array);             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_q_array, 3, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_14 = __pyx_memoryview_fromslice(__pyx_v_S_array, 3, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_14);
 ...
 */
  ...
  __Pyx_AddTraceback("mdtools.ana.sfactor.sfactor.compute_structure_factor", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_7mdtools_3ana_7sfactor_7sfactor_1compute_structure_factor(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_7mdtools_3ana_7sfactor_7sfactor_compute_structure_factor[] = "Calculates S(|q|) for all possible q values. Returns the q values as well as the scattering factor.";
static PyObject *__pyx_pw_7mdtools_3ana_7sfactor_7sfactor_1compute_structure_factor(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_positions,&__pyx_n_s_boxdimensions,&__pyx_n_s_start_q,&__pyx_n_s_end_q,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_boxdimensions)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("compute_structure_factor", 1, 4, 4, 1); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_start_q)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("compute_structure_factor", 1, 4, 4, 2); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_end_q)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("compute_structure_factor", 1, 4, 4, 3); __PYX_ERR(0, 11, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "compute_structure_factor") < 0)) __PYX_ERR(0, 11, __pyx_L3_error)
      }
    ...
    __pyx_v_positions = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0]); if (unlikely(!__pyx_v_positions.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_boxdimensions = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1]); if (unlikely(!__pyx_v_boxdimensions.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_start_q = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_start_q == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_end_q = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_end_q == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("compute_structure_factor", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 11, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("mdtools.ana.sfactor.sfactor.compute_structure_factor", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7mdtools_3ana_7sfactor_7sfactor_compute_structure_factor(__pyx_self, __pyx_v_positions, __pyx_v_boxdimensions, __pyx_v_start_q, __pyx_v_end_q);
...
static PyObject *__pyx_pf_7mdtools_3ana_7sfactor_7sfactor_compute_structure_factor(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_positions, __Pyx_memviewslice __pyx_v_boxdimensions, double __pyx_v_start_q, double __pyx_v_end_q) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("compute_structure_factor", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_positions.memview)) { __Pyx_RaiseUnboundLocalError("positions"); __PYX_ERR(0, 11, __pyx_L1_error) }
  if (unlikely(!__pyx_v_boxdimensions.memview)) { __Pyx_RaiseUnboundLocalError("boxdimensions"); __PYX_ERR(0, 11, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_7mdtools_3ana_7sfactor_7sfactor_compute_structure_factor(__pyx_v_positions, __pyx_v_boxdimensions, __pyx_v_start_q, __pyx_v_end_q, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "mdtools.ana.sfactor.sfactor.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "mdtools.ana.sfactor.sfactor.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "mdtools.ana.sfactor.sfactor.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "mdtools.ana.sfactor.sfactor._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"compute_structure_factor", (PyCFunction)__pyx_pw_7mdtools_3ana_7sfactor_7sfactor_1compute_structure_factor, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7mdtools_3ana_7sfactor_7sfactor_compute_structure_factor},
  {0, 0, 0, 0}
};
 ...
 *     cdef double[:] q_factor = np.empty(3,dtype=np.double);
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_int_3); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 18, __pyx_L1_error)
 ...
 *     n_atoms = positions.shape[0];
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_int_3); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 20, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initsfactor(void); /*proto*/
PyMODINIT_FUNC initsfactor(void)
#else
PyMODINIT_FUNC PyInit_sfactor(void); /*proto*/
PyMODINIT_FUNC PyInit_sfactor(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_sfactor(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_sfactor(void)", 0);
  ...
  #endif
  if (__pyx_module_is_main_mdtools__ana__sfactor__sfactor) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "mdtools.ana.sfactor.sfactor")) {
      if (unlikely(PyDict_SetItemString(modules, "mdtools.ana.sfactor.sfactor", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "mdtools/ana/sfactor/sfactor.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 * cimport numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init mdtools.ana.sfactor.sfactor", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init mdtools.ana.sfactor.sfactor");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
