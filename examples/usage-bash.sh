...
# The density profile has been written in a file named ``density.dat`` 
# in the current directory. The written file starts with the following 
# lines

head -n 20 density.dat 

# For lengthy analysis, use the ``concfreq`` option to update the
# result during the run
